...
const GuestView = ({ firebase }) => {
  const isGmailLoginEnabled = false;
  ...
  return (
    <div className="flex justify-center flex-col h-full">
      <CoditorLogo className="flex justify-center" size={200} />
      <div className="flex justify-center text-3xl text-blue-800 font-headline font-extrabold uppercase tracking-tight">
        Coditor
      </div>
      <div className="my-10 text-center text-gray-600 px-12 ">
        Coditor is a tool to Lorem Ipsum is simply dummy text of the printing
      ...
      <div className="flex px-10">
        {isGmailLoginEnabled && (
          <button
            onClick={googleLogin}
            className="flex-1 flex justify-center items-center py-3 shadow-lg bg-brand-google text-gray-100 rounded my-12 mx-3 font-medium"
          >
            <svg
              viewBox="0 0 128 128"
              width="25"
        ...
        <button
          onClick={githubLogin}
          className="flex-1 flex justify-center items-center py-3 shadow-lg bg-brand-github text-gray-100 rounded my-12 mx-3 font-medium"
        >
          <svg
            viewBox="0 0 128 128"
            width="25"
        ...
        {isFacebookLoginEnabled && (
          <button
            ...
            className="flex-1 flex justify-center items-center py-3 shadow-lg bg-brand-facebook text-gray-100 rounded my-12 mx-3 font-medium"
          >
            <svg
              viewBox="0 0 128 128"
              width="25"
...
export { GuestView };
export default withFirebase(GuestView);
